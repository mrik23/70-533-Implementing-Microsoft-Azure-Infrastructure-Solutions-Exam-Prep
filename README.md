...
Even if the exam has been refreshed in late 2016, so far I haven’t found much resources covering the new exam objectives. All third party online courses seem to be still based on the old model and not updated to match the new exam objectives. That will probably change soon, but for now I don’t really see other alternatives than studying directly from the official Azure documentation and free online video courses and demo from Microsoft (see links at the end).
...
PS: I’m still missing some links and some might not be so accurate, please comment to contribute.
